...
class GlassLayer(private val sceneEditor: SceneEditor)
    ...
    abstract inner class Arrow(name: String, val actorResource: DesignActorResource, val distance: Int)
    ...
    inner class RotateArrow(name: String, actorResource: DesignActorResource)
    ...
    inner class DirectionArrow(name: String, actorResource: DesignActorResource, val data: DesignAttributeData, distance: Int)
